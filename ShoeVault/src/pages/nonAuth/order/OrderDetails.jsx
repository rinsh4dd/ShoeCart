    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md p-6 bg-white rounded-lg shadow">
          ...
          <h2 className="text-xl font-medium text-gray-800 mt-4">Error Loading Order</h2>
              ...
              <div key={index} className="px-6 py-5 flex flex-col sm:flex-row">
                ...
                <div className="ml-0 sm:ml-6 flex-1">
                  ...
                  <div className="mt-4 flex justify-between items-end">
                    ...
                    <button onClick={()=>navigate("/product/:id")} className="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                      Buy it again
                    </button>
                  </div>
                </div>
