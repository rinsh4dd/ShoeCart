...
function BuyNowOverlay() {
  return (
    <div className="absolute inset-0 flex items-center justify-center group overflow-hidden rounded-lg">
      ...
      <button className="relative z-10 opacity-0 transform -translate-y-2 scale-95
      ...
      {/* Quick view option (appears at top) */}
      <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
        <button className="p-1.5 bg-white/90 backdrop-blur-sm rounded-full shadow-sm hover:bg-white">
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
